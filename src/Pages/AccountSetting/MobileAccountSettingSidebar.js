...
const MobileAccountSettingSidebar = ({openMobileSidebar, setSelectedSettings, selectedSettings, setOpenMobileSidebar}) => {
  return (
...
export default MobileAccountSettingSidebar
...
const MobileServiceSettingSidebar = ({openMobileSidebar, setSelectedSettings, selectedSettings}) => {
  return (
    ...
    <Link to="/myAccount/Profile" onClick={()=>{setSelectedSettings('Profile')}} className={`${selectedSettings == "Profile" ? " bg-blue-500 font-semibold" : ""} flex items-center space-x-2 rounded-md w-full py-4 px-5 cursor-pointer`}>
    ...
    <Link to="/myAccount/Bookings" onClick={()=>{setSelectedSettings('Bookings')}} className={`${selectedSettings == "Bookings" ? " bg-blue-500 font-semibold" : ""} flex items-center space-x-2 rounded-md w-full py-4 px-5 cursor-pointer`}>
    ...
    <Link to="/myAccount/BlockedServices" onClick={()=>{setSelectedSettings('BlockedServices')}} className={`${selectedSettings == "BlockedServices" ? "bg-blue-500  font-semibold" : ""} rounded-md flex items-center space-x-2  w-full py-4 px-5 cursor-pointer`}>
    ...
    <Link to="/myAccount/Favorites" onClick={()=>{setSelectedSettings('Favorites')}} className={`${selectedSettings == "Favorites" ? " bg-blue-500 font-semibold" : ""} flex items-center space-x-2 rounded-md w-full py-4 px-5 cursor-pointer`}>

...
const AboutUs = () => {
  ...
  return (
    <div className='h-fit md:h-full relative w-full py-5 md:py-0 bg-themeBlue semiMd:bg-gray-100 flex flex-col lg:flex-row gap-2'>
        <img src={wave} className="absolute hidden drop-shadow-lg semiMd:block w-full max-w-full object-cover h-full left-0 top-0" />
        {/* Left Section */}
        <div className='h-[80%] w-full  flex flex-col lg:flex-row'>
        <div className='w-full h-full flex flex-col relative z-10 p-10 lg:p-20'>
            <h1 data-aos='fade-right' className='text-4xl font-bold text-themeOrange'>About Kanoah</h1>

            <p data-aos='fade-right' className='text-white text-center lg:text-start text-sm md:text-lg lg:text-lg mt-10 leading-6 md:leading-9 font-light'>Welcome to KANOAH, your go-to service finder! 

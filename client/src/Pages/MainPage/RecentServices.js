...
const RecentServices = () => {
  ...
  return (
    ...
    <div className='Header w-full items-center  p-1 flex flex-col space-y-2'>
        <h1 className='text-themeBlue text-center text-4xl md:text-5xl font-bold'>Recent services</h1>
        ...
        <h3 className='text-themeBlue text-sm md:text-lg font-medium'>Newest Services</h3>
    </div>
